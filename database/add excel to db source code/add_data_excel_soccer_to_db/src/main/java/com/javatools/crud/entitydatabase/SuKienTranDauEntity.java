...
public class SuKienTranDauEntity {
    private int id;
    ...
    @ManyToOne
    @JoinColumn(name = "NGUOI_TAO", referencedColumnName = "ID", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "NGUOI_NHAN", referencedColumnName = "ID", nullable = false)
